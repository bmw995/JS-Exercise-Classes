...
class Instructor extends Lambdasian {
  ...
  giveGrade(student){
    return student.grade += (Math.floor(Math.random()*20+1)-7);
  }
...
class Student extends Lambdasian {
  ...
  listSubjects(){
    ...
    return this.favSubjects.reduce(reducer);
  }
  ...
  graduate(){
    if(this.grade < 70){
      return `I'm sorry ${this.name} your grade is below 70% and cannot graduate yet.`;
    } else {
      return `Congradulations ${this.name}!!!! YOU GRADUATED!!!`;
    }
